...
@Component({
  selector: 'app-core-one-old',
  templateUrl: './core-one-old.component.html',
  styleUrls: ['./core-one-old.component.scss']
})
export class CoreOneOldComponent implements OnInit {
